...
LOCATIONS = [
    ...
    ("녹동항", ["녹동"], 34.516, 127.130, ["DT_0026", "DT_0027"], 16, 1.08),
    ("미조항(남해)", ["미조"], 34.686, 128.088, ["DT_0061", "DT_0014", "DT_0016"], -5, 1.0, -14),
    # ── 동해 6 ──
    ("포항", ["포항"], 36.047, 129.384, ["DT_0091"], 0, 1.0),
    ("울산(방어진)", ["방어진", "울산"], 35.500, 129.417, ["DT_0020"], 0, 1.0, -2),
    ("후포", ["후포"], 36.677, 129.453, ["DT_0011"], -7, 1.0),
    ("묵호항", ["묵호"], 37.550, 129.115, ["DT_0006"], -6, 1.0),
    ("속초", ["속초"], 38.207, 128.594, ["DT_0012"], -4, 1.0),
    ("강릉항", ["강릉"], 37.766, 128.951, ["DT_0006", "DT_0057", "DT_0012"], -8, 1.0, 3),
]
