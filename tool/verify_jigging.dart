...
//        · 10월        매우좋음 2(13%) 좋음 2(13%) 보통 8(53%) 나쁨 3(20%)
//        · 11월(끝물)                  좋음 2(13%) 보통 8(53%) 나쁨 5(33%)
...
//   5. 제철 흐름 — 9월(금어기 해제) > 10월 > 11월, 그리고 9월 ≫ 8월.
...
void main() {
  ...
  for (final s in ['쭈꾸미', '갑오징어']) {
    ...
    check(
      score(s, jogeum, 11) < score(s, jogeum, 10),
      '$s: 11월(끝물)은 10월보다 낮아야 한다',
    );
  }
